...
export const categories = [
  ...
  export const blogPosts: BlogPost[] = [
    ...
    {
      id: '6',
      title: "Optimiser sa consommation de carburant",
      excerpt: "Conseils pratiques et techniques pour réduire la consommation de carburant de votre véhicule sans sacrifier les performances.",
      content: `
        <article>
          <h2>Facteurs influençant la consommation</h2>
          <ul>
            <li>Style de conduite</li>
            <li>Maintenance du véhicule</li>
            <li>Pression des pneus</li>
            <li>Aérodynamisme</li>
          </ul>
  
          <h2>Solutions techniques</h2>
          <p>Plusieurs modifications peuvent optimiser la consommation :</p>
          <ul>
            <li>Reprogrammation adaptée</li>
            <li>Filtres performance</li>
            <li>Optimisation de l'injection</li>
          </ul>
  
          <h2>Conseils pratiques</h2>
          <p>Des gestes simples pour économiser du carburant au quotidien.</p>
        </article>
      `,
      image: "/blog/consumption.jpg",
      category: "Conseils",
      readTime: "4 min",
      slug: "optimiser-consommation-carburant",
      date: "2024-02-20",
      author: "Bouëxière Méca Perf",
      tags: ["consommation", "économie", "performance"]
    }
  ];
